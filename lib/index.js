...
var Throttle = function (_Transform) {
  ...
  _createClass(Throttle, [{
    ...
    value: function process(chunk, pos, done) {
      ...
      if (this.initburst > 0) {
        this.push(slice);
        this.initburst -= slice.length;
        this.process(this, chunk, pos + this.chunksize, done);
        return;
      }
      this.bucket.removeTokens(slice.length, function (err) {
        ...
        _this2.push(slice);
        _this2.process(_this2, chunk, pos + _this2.chunksize, done);
      });
    }
  }, {
    key: '_transform',
